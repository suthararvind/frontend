...
const Cart = () => {
  ...
  const {
    cartItems: {
      cheeseBurger: { quantity: cheeseBurger }, //or const cheeseBurger=cartItems.cheeseBurger.quantity
      vegCheeseBurger: { quantity: vegCheeseBurger },
      burgerWithFries: { quantity: burgerWithFries },
    },
    subTotal, tax, shippingCharges, total,
    } = useSelector((state) => state.cart); //here we take data from cartReducer 

    //we  are taking cartitem by the name of orderitems
