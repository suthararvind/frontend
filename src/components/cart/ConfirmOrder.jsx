...
//what to do the data below received data is defined in order->actions
const ConfirmOrder = () => {
  // shippingInfo,
  //   orderItems,
  //   paymentMethod,
  ...
  //data from previous page will be sent forwarded
